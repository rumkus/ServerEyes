...
import { View, Text, TextInput, TouchableOpacity, StyleSheet, ActivityIndicator, FlatList, StatusBar, Vibration, Share, ScrollView, AppState, RefreshControl } from 'react-native';
